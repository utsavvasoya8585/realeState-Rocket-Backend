      ...
      html: `<p> 
            ...
            ">
                ...
                <tr>
                    ...
                    <td>Carbon Monoxide Detector:${
                      req.body.Fireplace_CarbonMonoxideDetector
                    }</td>

                </tr><tr>
                    <td>Recycling receptacle: ${
